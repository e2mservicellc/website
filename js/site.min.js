...
!function(t){"use strict";var e=function(t){var e="./images/portfolio/"+t[0]+"/"+t[1]+"-gallery.jpg";return{src:e,thumb:e,subHtml:"<h4>"+t[2]+"</h4><p>"+t[3]+"</p>"}},o=function(o,n){t("#"+o).on("click",function(){t(this).lightGallery({dynamic:!0,dynamicEl:[e(n[0])],loop:!1,hideControlOnEnd:!0})})},n=[["kitchen","1","",""]];o("kitchenCollection",n);var i=[["bathroom","1","",""]];o("bathroomCollection",i);var l=[["basement","1","",""]];o("basementCollection",l);var a=[["fence","1","",""]];o("fenceCollection",a);var c=[["deck","1","",""]];o("deckCollection",c);var r=[["shed","1","",""]];o("shedCollection",r)}(jQuery),function(t){"use strict";t("a.page-scroll").bind("click",function(e){var o=t(this);t("html, body").stop().animate({scrollTop:t(o.attr("href")).offset().top-50},1250,"easeInOutExpo"),e.preventDefault()}),t("body").scrollspy({target:".navbar-fixed-top",offset:51}),t(".navbar-collapse ul li a").click(function(){t(".navbar-toggle:visible").click()}),t("h1").fitText(1.2,{minFontSize:"35px",maxFontSize:"65px"}),t("#mainNav").affix({offset:{top:100}}),(new WOW).init()}(jQuery);